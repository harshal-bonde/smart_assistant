    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        titleMedium: TextStyle(
            ...
            color: AppColors.lightText),
        bodyLarge: TextStyle(
            fontSize: 16, color: AppColors.lightTextSecondary, height: 1.5),
        bodyMedium: TextStyle(
            fontSize: 14, color: AppColors.lightTextSecondary, height: 1.5),
        bodySmall: TextStyle(
            fontSize: 12,
            color: AppColors.lightTextTertiary,
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        titleMedium: TextStyle(
            ...
            color: AppColors.darkText),
        bodyLarge: TextStyle(
            fontSize: 16, color: AppColors.darkTextSecondary, height: 1.5),
        bodyMedium: TextStyle(

...
class SuggestionsRemoteDataSourceImpl implements SuggestionsRemoteDataSource {
  static const _allSuggestions = [
    ...
    },
    {
      'id': 5,
      'title': 'Write a poem',
      'description': 'Generate creative poetry on any topic'
    },
    {
      'id': 6,
      'title': 'Code review',
    ...
    },
    {
      ...
      'description': 'Draft slide content and talking points'
    },
    {
      'id': 13,
      'title': 'Analyze data',
      'description': 'Get insights from your dataset'
    },
    {
      'id': 14,
      'title': 'Write a cover letter',
      'description': 'Craft a compelling job application'
    },
    {
      'id': 15,
      'title': 'Debug my code',
    ...
    },
    {
      ...
      'description': 'Improve your app speed and efficiency'
    },
    {
      'id': 17,
      'title': 'Design a database',
      'description': 'Plan your database schema and relations'
    },
    {
      'id': 18,
      'title': 'Write documentation',
      'description': 'Create clear and helpful docs'
    },
    {
      'id': 19,
      'title': 'Plan a meeting',
      'description': 'Create agenda and talking points'
    },
    {
      'id': 20,
      'title': 'Simplify my writing',
      'description': 'Make complex text easier to read'
    },
    {
      'id': 21,
      'title': 'Generate API docs',
      'description': 'Document your REST API endpoints'
    },
    {
      'id': 22,
      'title': 'Create a workout plan',
      'description': 'Design a personalized fitness routine'
    },
    {
      'id': 23,
    ...
    },
    {
      'id': 26,
      'title': 'Write a story',
      'description': 'Generate creative fiction narratives'
    },
    {
      'id': 27,
      'title': 'Create flashcards',
      'description': 'Study aids for any subject'
    },
    {
      'id': 28,
      'title': 'Proofread document',
      'description': 'Check for errors and improve clarity'
    },
    {
      'id': 29,
      'title': 'Generate SQL queries',
      'description': 'Write database queries from descriptions'
    },
    {
      'id': 30,
      'title': 'Summarize a book',
      'description': 'Get key takeaways from any book'
    },
    {
      'id': 31,
      'title': 'Write a speech',
      'description': 'Craft an engaging presentation speech'
    },
    {
      'id': 32,
    ...
    },
    {
      'id': 33,
      'title': 'Design a logo',
      'description': 'Get creative logo design suggestions'
    },
    {
      'id': 34,
      'title': 'Write a review',
      'description': 'Compose thoughtful product reviews'
    },
    {
      'id': 35,
      'title': 'Explain an error',
      'description': 'Understand and fix error messages'
    },
    {
      'id': 36,
    ...
    },
    {
      ...
      'description': 'Break down projects into milestones'
    },
    {
      'id': 39,
      'title': 'Generate regex',
      'description': 'Create regular expressions from descriptions'
    },
    {
      'id': 40,
    ...
    },
    {
      ...
      'description': 'Design effective questionnaires'
    },
    {
      'id': 42,
      'title': 'Explain a formula',
      'description': 'Break down mathematical formulas'
    },
    {
      'id': 43,
      'title': 'Write a contract',
      'description': 'Draft basic legal agreements'
    },
    {
      'id': 44,
      'title': 'Create a menu',
      'description': 'Design a restaurant or event menu'
    },
    {
      'id': 45,
      'title': 'Write release notes',
      'description': 'Document software release changes'
    },
    {
      'id': 46,
      'title': 'Plan a party',
      'description': 'Organize event details and logistics'
    },
    {
      'id': 47,
      'title': 'Create a playlist',
      'description': 'Curate music for any mood or occasion'
    },
    {
      'id': 48,
      'title': 'Write a FAQ',
